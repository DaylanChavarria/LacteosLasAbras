...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="./presentacion/images/icon.png">
        ...
        <!-- Animate.css -->
        <link rel="stylesheet" href="./presentacion/css/animate.css">
        <!-- Icomoon Icon Fonts-->
        <link rel="stylesheet" href="./presentacion/css/icomoon.css">
        <!-- Simple Line Icons -->
        <link rel="stylesheet" href="./presentacion/css/simple-line-icons.css">
        <!-- Datetimepicker -->
        <link rel="stylesheet" href="./presentacion/css/bootstrap-datetimepicker.min.css">
        <!-- Flexslider -->
        <link rel="stylesheet" href="./presentacion/css/flexslider.css">
        <!-- Bootstrap  -->
        ...
        <!-- Modernizr JS -->
        <script src="./presentacion/js/modernizr-2.6.2.min.js"></script>

        <script src="./presentacion/js/jquery.min.js"></script>
    ...
    <body>
        ...
        <div id="fh5co-container">
            <div id="fh5co-home" class="js-fullheight" data-section="home">
                ...
                <div class="flexslider">
                    ...
                    <ul class="slides">
                        <li style="background-image: url(./presentacion/images/img1.jpeg);" data-stellar-background-ratio="0.5"></li>
                        <li style="background-image: url(./presentacion/images/img3.jpeg);" data-stellar-background-ratio="0.5"></li>
                        <li style="background-image: url(./presentacion/images/img2.jpeg);" data-stellar-background-ratio="0.5"></li>
                    </ul>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="fh5co-logo">
                            <a data-toggle="modal" href="#myModal">     
                                <img src="./presentacion/images/logo.png" alt="Nuestro Logo">
                            </a>        
                        </div>
                        <div class="fh5co-menu-2 dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="#"><img src="presentacion/images/ingles.png"/> Inglés</a></li>
                                <li><a href="#"><img src="presentacion/images/español.png"/> Español</a></li>
                            </ul>
            ...
            <div id="fh5co-events" data-section="events" style="background-image: url(./presentacion/images/product.jpg);" data-stellar-background-ratio="0.5">
                <div class="fh5co-overlay"></div>
                <div class="container">
                    <div class="row text-center fh5co-heading row-padded">
        ...
        <!-- jQuery -->
        <script src="./presentacion/js/bootstrap-modal.js"></script>
        <script src="./presentacion/js/jquery.js"></script>
        <script src="./presentacion/js/jquery.min.js"></script>

        <!-- jQuery Easing -->
        <script src="./presentacion/js/jquery.easing.1.3.js"></script>
        <!-- Bootstrap -->
        <script src="./presentacion/js/bootstrap.min.js"></script>
        <!-- Bootstrap DateTimePicker -->
        <script src="./presentacion/js/moment.js"></script>
        <script src="./presentacion/js/bootstrap-datetimepicker.min.js"></script>
        <!-- Waypoints -->
        <script src="./presentacion/js/jquery.waypoints.min.js"></script>
        <!-- Stellar Parallax -->
        <script src="./presentacion/js/jquery.stellar.min.js"></script>

        <!-- Flexslider -->
        <script src="./presentacion/js/jquery.flexslider-min.js"></script>
        <script>
            $(function () {
                $('#date').datetimepicker();
            });
